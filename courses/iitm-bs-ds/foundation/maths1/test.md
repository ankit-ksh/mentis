...
sidebar:
    collapsible: true
---
# Maths 1: Introduction

Welcome to the **Maths 1** course. Here we will cover foundational topics in mathematics.

## Course Overview
In this course, we will explore key topics such as:
- **Introduction to Calculus**
- **Differentiation**
- **Integration**

Start with the topics in the sidebar to navigate the course!
